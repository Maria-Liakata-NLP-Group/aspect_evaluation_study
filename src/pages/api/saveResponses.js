...
export default async function handler(req, res) {
  ...
  const {claimId, workpackage, annotationResponse, participant, progress, dataLength} = req.body;
  ...
  if (!claimId || !workpackage || !participant || !annotationResponse || !progress || !dataLength) {
